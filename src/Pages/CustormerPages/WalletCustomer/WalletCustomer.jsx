...
function WalletCustomer() {
    ...
    return (
        <div className='wallet-container'>
            <form style={{width: "50%"}} className='wallet-form' onSubmit={handleDepositMoney}>
                ...
                <div className="wallet-money">
                    {/* <h3>Chọn mệnh giá</h3> */}
                    <button onClick={() => setMoney(100000)}>100.000</button>
                    <button onClick={() => setMoney(200000)}>200.000</button>
                    <button onClick={() => setMoney(500000)}>500.000</button>
                    <button onClick={() => setMoney(1000000)}>1.000.000</button>
                    <button onClick={() => setMoney(10000000)}>10.000.000</button>
                </div>
